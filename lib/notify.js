...
// Suggested message templates. Coordinators can edit before sending
// (the UI puts the text in an editable field before opening wa.me).
export const WA_TEMPLATES = Object.freeze({
  janmashtami_invite: (name) =>
    `Hare Krsna ${name || ""}!\n\nSri Krsna-Janmastami is coming up at ISKCON Thiruppalai. We would love to have you chant with us. Reply to know more.`,
  daily_reminder: (name) =>
    `Hare Krsna ${name || ""}, did you complete your daily japa today? Even one round matters. 🌸`,
  yajna_invite: (name, date, venue) =>
    `Hare Krsna ${name || ""}! You are invited to the Nama-Japa-Yajna on ${date || "the announced date"}${venue ? " at " + venue : ""}. Please confirm your attendance.`,
  followup: (name) =>
    `Hare Krsna ${name || ""}, we missed you. Everything alright? Please let me know how I can help you continue your chanting.`,
});

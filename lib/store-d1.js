  ...
  return {
    ...
    async createPerson(fields) {
      ...
      const cols = [
        ...
        "assigned_to_user_id","notes","active","created_at","updated_at",
      ];
      await run(
    ...
    async createUser(fields) {
      ...
      await run(
        `INSERT INTO users (id, person_id, username, password_hash, display_name, role, phone, email, active, created_at, last_login_at, wa_template_daily, wa_template_nondaily)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
